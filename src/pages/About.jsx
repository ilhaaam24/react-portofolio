  ...
  return (
    <div id="about" className="flex flex-col items-center justify-evenly  md:p-6 gap-6 md:min-h-screen md:py-10">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center  gap-8">
        <motion.img src="../src/assets/aboutbw.jpg" className="w-[250px] h-[250px] border-2 rounded-xl object-cover i" alt="Profile" initial="hidden" animate={controls} variants={fadeInLeft} />
